...
<template>
    <AppLayout>
        ...
        <div class="bg-white rounded-xl overflow-auto" style="max-height: calc(100vh - 140px)">
            <div class=" grid grid-cols-3 p-5 gap-5" v-if="$page.props.user.student">
                <div class="rounded-lg drop-shadow-lg bg-white" v-for="subject in subjects" :key="subject.id">
                    <div
                        ...
                        <div>
                            <a :href="route('classroom_room_view')" class="text-2xl font-bold underline">{{
                                    subject.name
                            }}</a>
            ...
            <div class="bg-white rounded-xl p-5" v-if="$page.props.user.teacher">
                ...
                <div class="grid grid-cols-3 gap-5">
                    <div class="rounded-lg drop-shadow-lg bg-white" v-for="subject in subjects" :key="subject.id">
                        ...
                        <div class="px-1 py-2 text-right">
                            <button class="btn btn-sm btn-ghost">เข้าห้องเรียน<span
